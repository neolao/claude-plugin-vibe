---
name: review-robustness-finds-cross-module-violations
description: review-robustness must find a Swallowed error, Async, Timeout/limit, Resource and Lost context defect that each span two modules of fixtures/, without flagging a chained exception or a finally-guarded lock
tags: [review-robustness, recall]
runs: 3
max_turns: 10
timeout_seconds: 300
...
Invoke the `vibe:review-robustness` sub-agent (Agent tool, `subagent_type: "vibe:review-robustness"`) to review `fixtures/` in this case directory. Give it exactly this prompt:
