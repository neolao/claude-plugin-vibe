---
name: review-ddd-no-false-positives
description: review-ddd must not flag Order's encapsulated invariants, Money's immutable value equality, the domain-service-driven approval rule, or OrderRepository returning domain objects
tags: [review-ddd, precision]
runs: 3
max_turns: 10
timeout_seconds: 300
