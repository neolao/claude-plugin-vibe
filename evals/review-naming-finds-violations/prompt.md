---
name: review-naming-finds-violations
description: review-naming must find a Variable, Function, Type, Module, and Test naming violation across fixtures/
tags: [review-naming, recall]
runs: 3
max_turns: 10
timeout_seconds: 300
