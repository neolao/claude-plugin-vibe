---
name: review-security-finds-cross-module-vulnerabilities
description: review-security must find an Injection (shell), Injection (path), Dangerous primitive, Crypto and Access control defect that each span two modules of fixtures/, without flagging list-form subprocess calls or the secrets-based API key
