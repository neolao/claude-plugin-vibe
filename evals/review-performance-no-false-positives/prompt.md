---
name: review-performance-no-false-positives
description: review-performance must not flag the batched product fetch, the bounded cache, the O(1) reservation lookup, the once-at-startup config load, the batched render loop, or the one-shot migration script
tags: [review-performance, precision]
runs: 3
max_turns: 10
timeout_seconds: 300
