---
name: review-robustness-finds-violations
description: review-robustness must find a Swallowed error, Async, Timeout/limit, Resource, and Lost context finding across fixtures/
