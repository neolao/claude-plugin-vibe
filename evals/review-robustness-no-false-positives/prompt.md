---
name: review-robustness-no-false-positives
description: review-robustness must not flag the specific-exception re-raise, the explicitly marked fire-and-forget task, the timed/capped/backed-off retry, or the with-guarded resource handling with a preserved cause
tags: [review-robustness, precision]
runs: 3
max_turns: 10
timeout_seconds: 300
