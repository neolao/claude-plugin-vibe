---
name: review-antipatterns-no-false-positives
description: review-antipatterns must not flag Money/OrderStatus/MAX_RETRIES as primitive obsession or mutable global state, OrderRepository.save as feature envy, PaymentGateway's keyword-argument charge as boolean blindness, or OrderService's constructor-injected flow as temporal coupling
tags: [review-antipatterns, precision]
runs: 3
max_turns: 10
timeout_seconds: 300
