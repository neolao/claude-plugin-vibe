---
name: review-hygiene-finds-cross-module-violations
description: review-hygiene must find cross-module dead code and duplication in fixtures/, plus an unused local and a stale marker, without flagging a ticketed TODO
tags: [review-hygiene, recall]
runs: 3
max_turns: 10
timeout_seconds: 300
