...
Invoke the `vibe:review-security` sub-agent (Agent tool, `subagent_type: "vibe:review-security"`) to review `fixtures/app.py` in this case directory. Give it exactly this prompt:
