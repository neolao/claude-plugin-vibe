---
name: review-dependencies-finds-violations
description: review-dependencies must find a Vulnerability, an Abandoned package, a Version hygiene issue, an Unused dependency, and a Misplaced dependency in fixtures/
tags: [review-dependencies, recall]
runs: 3
max_turns: 10
timeout_seconds: 300
