---
name: review-overengineering-no-false-positives
description: review-overengineering must not flag a test seam actually used by tests, a strategy with two real implementations, configurability that legitimately varies, a measured cache, or proportionate layering
tags: [review-overengineering, precision]
runs: 3
max_turns: 10
timeout_seconds: 300
...
Invoke the `vibe:review-overengineering` sub-agent (Agent tool, `subagent_type: "vibe:review-overengineering"`) to review `fixtures/` in this case directory. Give it exactly this prompt:
