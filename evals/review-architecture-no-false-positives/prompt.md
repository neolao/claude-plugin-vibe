---
name: review-architecture-no-false-positives
description: review-architecture must not flag a correctly hexagonal app — core-owned port, injected gateway, a genuine composition root, and a driver-aware adapter that stays inside its own boundary
tags: [review-architecture, precision]
runs: 3
max_turns: 10
timeout_seconds: 300
